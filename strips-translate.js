...
const STRIPS_SETTINGS = {
    ...
    TEMP_SEND_IMMEDIATELY_THRESHOLD    : { id: 0x05, unit: 'mC',          decode: decodeU32dec,  encode: encodeU32,     name:'Temp send immediately threshold'  },
    TEMP_SEND_THROTTLED_THRESHOLD      : { id: 0x06, unit: 'mC',          decode: decodeU32dec,  encode: encodeU32,     name:'Temp send throttled threshold'  },
    ...
    AVGTEMP_SEND_IMMEDIATELY_THRESHOLD : { id: 0x0D, unit: 'mC',          decode: decodeU32dec,  encode: encodeU32,     name:'Averate temp send immediately threshold'  },
    ...
    HUMIDITY_THRESHOLD                 : { id: 0x12, unit: '%',           decode: decodeU32dec,  encode: encodeU32,     name:'Humidity threshold'  },
    ...
    FLOOD_ALARM_THRESHOLD              : { id: 0x1C, unit: '%',           decode: decodeU32dec,  encode: encodeU32,     name:'Flood alarm threshold'  },
    FLOOD_ALARM_HYSTERESIS            : { id: 0x1D, unit: '%',           decode: decodeU32dec,  encode: encodeU32,     name:'Flood alarm hysteresis'  },
    SETTINGS_FOIL_THRESHOLD            : { id: 0x1E, unit: 'capacitance', decode: decodeU32dec,  encode: encodeU32,     name:'Foil threshold'  },
    ...
    PRESENCE_THRESHOLD                 : { id: 0x30, unit: 'reflection',  decode: decodeU32dec,  encode: encodeU32,     name:'Presence threshold'  },
